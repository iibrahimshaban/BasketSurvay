    ...
    public partial class CreateNewDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "6dc6528a-b280-4770-9eae-82671ee81ef7", 0, "99d2bbc6-bc54-4248-a172-a77de3ae4430", "Admin@SurvayBasket.com", true, "Ibrahim", "khaled", false, null, "ADMIN@SURVAYBASKET.COM", "IIBRAHIM", "AQAAAAIAAYagAAAAECy23xfjCMGZkh5x+DU3n7vgTTS7pKU806Tn/qQcBw0dtUt6guT+NZfsQhIzKSR/uQ==", null, false, "55BF92C9EF0249CDA210D85D1A851BC9", false, "iibrahim" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Permissions", "Polls:Create", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    ...
                    { 6, "Permissions", "Questions:Create", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 7, "Permissions", "Questions:Update", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 8, "Permissions", "User:Read", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 9, "Permissions", "User:create", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 10, "Permissions", "User:Update", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 11, "Permissions", "Roles:Read", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
                    { 12, "Permissions", "Roles:create", "92b75286-d8f8-4061-9995-e6e23ccdee94" },
